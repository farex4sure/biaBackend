...
exports.otpMailer = otpMailer;
exports.forgotPasswordMailer = forgotPasswordMailer;
const nodemailer_1 = __importDefault(require("nodemailer"));
// Define a reusable function to send OTP emails
async function otpMailer(email, otp, fullname) {
...
async function forgotPasswordMailer(email, url) {
    const transporter = nodemailer_1.default.createTransport({
        service: 'gmail',
        auth: {
            user: process.env.EMAIL_USER,
