...
exports.forgotPassword = exports.resendOtp = exports.verifyOtp = exports.register = exports.login = exports.refreshToken = void 0;
...
const refreshToken = async (token) => {
    ...
    const validationResponse = await v.validate({ token }, schema);
    ...
    try {
        ...
        const accessToken = (0, jwt_util_1.generateAccessToken)({ id: payload.id, email: payload.email });
        return { accessToken };
    }
    catch (err) {
        throw {
